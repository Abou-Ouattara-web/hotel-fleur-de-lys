...
<head>
    ...
    <title>Inscription - FLEUR DE LYS</title>
    <meta name="description" content="Créez votre compte à l'Hôtel Fleur de Lys pour profiter d'offres exclusives et d'un séjour sur-mesure à Tiassalé.">
    <meta name="keywords" content="inscription hotel, compte client fleur de lys, offres exclusives hotel">
    ...
    <style>
        ...
        @media (max-width: 900px) {
            ...
            .inscription-form-container { padding: 30px 15px; }
        }
                ...
                <div class="nav-menu" id="nav-menu">
                    <ul>
                        ...
                        <?php if(!isset($_SESSION['user_id'])): ?>
                            <li><a href="<?php echo URL_ROOT; ?>/inscription" class="active">Inscription</a></li>
                        <?php else: ?>
    ...
    <div class="page-title">
        <div class="container">
            ...
            <div class="breadcrumb">
                <a href="<?php echo URL_ROOT; ?>/">Accueil</a> / <span>Inscription</span>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="inscription-wrapper">
                <div class="inscription-form-container">
                    ...
                    <p class="inscription-subtitle">Pour bénéficier de nos offres exclusives</p>
                    
                    <form id="inscriptionForm" class="inscription-form" action="<?php echo URL_ROOT; ?>/api/auth/register" method="POST">
                        <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="telephone" name="telephone" placeholder="<?php echo htmlspecialchars($siteSettings['hotel_phone'] ?? '+225 07 03 24 44 64'); ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <button type="button" class="btn-eye" onclick="togglePassword('password', this.querySelector('i'))" aria-label="Afficher/Masquer le mot de passe">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <button type="button" class="btn-eye" onclick="togglePassword('confirm_password', this.querySelector('i'))" aria-label="Afficher/Masquer la confirmation">
                                    <i class="fas fa-eye"></i>
                                </button>
                            </div>
                        ...
                        <div class="login-link">
                            Déjà un compte ? <a href="<?php echo URL_ROOT; ?>/login">Connectez-vous</a>
                        </div>
                    </form>
                </div>
                ...
                <div class="inscription-info">
                    <div class="benefits-content">
                        ...
                        <ul class="benefits-list">
                            <li><i class="fas fa-gift"></i> <span>10% de réduction sur votre première réservation</span></li>
                            <li><i class="fas fa-percent"></i> <span>Offres exclusives membres</span></li>
                            <li><i class="fas fa-calendar-check"></i> <span>Réservation prioritaire</span></li>
                            <li><i class="fas fa-champagne-glasses"></i> <span>Cocktail de bienvenue offert</span></li>
                            <li><i class="fas fa-clock"></i> <span>Late check-out gratuit</span></li>
                        </ul>
                    </div>
                </div>
            </div>
